...
function LinearProgress(props) {
  ...
  var dashedClass = (0, _classnames.default)(
    classes.dashed,
    ((_classNames2 = {}),
    (0, _defineProperty2.default)(
      _classNames2,
      classes.dashedColorPrimary,
      color === "primary"
    ),
    (0, _defineProperty2.default)(
      _classNames2,
      classes.dashedColorSecondary,
      color === "secondary"
    ),
    _classNames2)
  );
  ...
  if (variant === "buffer") {
    if (valueBuffer !== undefined) {
      inlineStyles.bar2.transform = "scaleX(".concat(
        (valueBuffer || 0) / 100,
        ")"
      );
    } else {
