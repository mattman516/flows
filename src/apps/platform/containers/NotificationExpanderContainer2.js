...
import { NotificationExpander2 } from "../../../components/dialogs/NotificationExpander";
...
const mapDispatchToProps = dispatch => ({
  ...
  onTabChange: (event, value) =>
    dispatch(onNotificationExpandTabChange(event, value))
});
